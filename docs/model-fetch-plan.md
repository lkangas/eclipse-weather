...
- **cron/systemd timers** on an always-on box (redacted-host would do) + a dead-man's-switch ping (healthchecks.io style) — a silently dead archiver during Aug 5–12 is the worst failure mode

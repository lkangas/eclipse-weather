...
- [x] **T34** Tool 1: "latest run of every model" explorer, first real slice
      ...
      **Verified for real, live endpoints**: gfs run 2026-07-23T00Z, 209/209
      ...
      single latest run — a real data point for the eventual the-vps
...
## Tool 1/2/3 rollout — desktop now, the-vps later
...
- [ ] **3. Migrate existing renderings to the-vps** (once step 2 is
      approved, not before). Copy already-rendered output from this desktop
      to the-vps, bootstrapping production with real historical renders
...
- [ ] **4. The-vps's own fetch → render → discard pipeline.** Unlike this
...
- [ ] **6. Rendering-priority scheme as Aug 12 approaches.** Once render
      ...
      and/or step 4's the-vps pipeline is live.
